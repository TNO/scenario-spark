...
import { MeiosisComponent, routingSvc, setPage } from '../services';
            ...
            m('ul.list-inline', [
              m(
                ...
                m(
                  ...
                  {
                    href: '#goal',
                    onclick: (e: MouseEvent) => scrollToSection(e, 'goal'),
                  },
              ...
              m(
                ...
                m(
                  ...
                  {
                    href: '#usage',
                    onclick: (e: MouseEvent) => scrollToSection(e, 'usage'),
                  },
                  'Hoe te gebruiken'
                )
              ),
              ...
              m(
                ...
                m(
                  ...
                  {
                    href: '#settings',
                    onclick: (e: MouseEvent) => scrollToSection(e, 'settings'),
                  },
                  'Beheer'
                )
              ),
              ...
              m(
                ...
                m(
                  ...
                  {
                    href: '#security',
                    onclick: (e: MouseEvent) => scrollToSection(e, 'security'),
                  },
                  'Security'
                )
              ),
