...
export const messagesNL: typeof messages = {
  ...
  LLM_WIZARD_STEP1_DESC: 'Vul onderstaande details in om uw morfologische box te genereren:',
  LLM_WIZARD_STEP2_TITLE: 'Bekijk Prompt',
  LLM_WIZARD_STEP2_SUBTITLE: 'Bekijk en bewerk de volledige prompt',
  LLM_WIZARD_STEP2_DESC: 'Bekijk de gecombineerde prompt hieronder. U kunt deze indien nodig bewerken:',
  LLM_WIZARD_STEP3_TITLE: 'Configureer LLM',
  LLM_WIZARD_STEP3_SUBTITLE: 'Kies LLM service en instellingen',
  LLM_WIZARD_STEP3_DESC: 'Configureer hoe u de morfologische box wilt genereren:',
  LLM_WIZARD_STEP4_TITLE: 'Genereer Scenario',
  LLM_WIZARD_STEP4_SUBTITLE: 'Genereer of plak het resultaat',
  LLM_WIZARD_STEP4_CLIPBOARD_DESC: 'De prompt is klaar. Kopieer deze en gebruik een externe LLM om de morfologische box te genereren:',
  LLM_PURPOSE: 'Doel',
  LLM_PURPOSE_HELP: 'Wat wilt u onderzoeken of ontwerpen? Bijv. "crisismanagement scenario\'s voor nationale rampenplanning"',
  LLM_DOMAIN: 'Domein',
  LLM_DOMAIN_HELP: 'Specificeer het vakgebied of de context, bijv. "rampenbestrijding", "cyberbeveiliging", "militaire operaties"',
  LLM_OUTPUT_TYPE: 'Output Type',
  LLM_OUTPUT_TYPE_HELP: 'Één morfologische box, meerdere boxen, scenario-gericht, maatregel-gericht, of beide?',
  LLM_CONSTRAINTS: 'Beperkingen of Focusgebieden',
  LLM_CONSTRAINTS_HELP: 'Bijv. "Inclusief sociaal-politieke, ecologische en technologische factoren"',
  LLM_DETAIL_DEPTH: 'Detailniveau',
  LLM_DETAIL_DEPTH_HELP: 'Bijv. "Inclusief 6-7 gedetailleerde opties per factor, elk met een definitie van één zin"',
  LLM_LANGUAGE: 'Output Taal',
  LLM_LANGUAGE_HELP: 'De taal voor de gegenereerde inhoud, bijv. "Nederlands", "Engels"',
