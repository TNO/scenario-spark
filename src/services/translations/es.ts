...
export const messages: typeof messagesEN = {
  ...
  FILTER_NARRATIVES: 'Filtrar escenarios',
  FILTER_NARRATIVES_PLACEHOLDER: 'Escriba para filtrar por nombre...',
  NARRATIVE: 'narrativa',
  ...
  INCLUDE_MAP_SUPPORT: 'Activar soporte de mapa',
  MAP_CONFIG: 'Configuración del mapa',
  MAP_UNITS: 'Unidades del mapa',
  METRIC: 'Métrico',
  IMPERIAL: 'Imperial',
  OSM_AMENITIES: 'Servicios OSM',
  TOGGLE_MAP: 'Mostrar/ocultar mapa',
  ZOOM_LEVEL: 'Nivel de zoom',
  CIRCLE: 'Círculo',
  ELLIPSE: 'Elipse',
  OSM_QUERY: 'Consulta OSM',
  RADIUS: 'Radio (m)',
  RADII: 'Radios (separados por coma, en metros)',
  MAJOR_AXIS: 'Eje mayor (m)',
  MINOR_AXIS: 'Eje menor (m)',
