...
export const messages: typeof messagesEN = {
  ...
  INCLUDE_DECISION_SUPPORT: 'Activeer beslissingsondersteuning',
  INCLUDE_MAP_SUPPORT: 'Activeer kaartondersteuning',
  MAP_CONFIG: 'Kaartconfiguratie',
  MAP_UNITS: 'Kaart eenheden',
  METRIC: 'Metrisch',
  IMPERIAL: 'Imperiaal',
  OSM_AMENITIES: 'OSM Voorzieningen',
  TOGGLE_MAP: 'Toon/Verberg kaart',
  ZOOM_LEVEL: 'Zoomniveau',
  CIRCLE: 'Cirkel',
  ELLIPSE: 'Ellips',
  OSM_QUERY: 'OSM Zoekopdracht',
  RADIUS: 'Straal (m)',
  RADII: 'Stralen (komma gescheiden, in meters)',
  MAJOR_AXIS: 'Lange as (m)',
  MINOR_AXIS: 'Korte as (m)',
  ORIENTATION: 'Oriëntatie',
  ORIENTATION_DESC: 'Hoek in graden (0 = Noord) of referentie ID',
  IS_DECISION_CATEGORY: 'Voor beslissingsondersteuning',
  ...
  TOGGLE: { SHOW: 'Toon kaart', HIDE: 'Verberg kaart' },
  AUTO_CREATE: {
    BTN: 'Autom.',
