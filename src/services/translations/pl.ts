...
export const messages: typeof messagesEN = {
  ...
  FILTER_NARRATIVES: 'Filtruj scenariusze',
  FILTER_NARRATIVES_PLACEHOLDER: 'Wpisz, aby filtrować po nazwie...',
  NARRATIVE: 'narracja',
  ...
  TEMPLATE_PROMPT_COPIED: 'Prompt szablonu skopiowany do schowka',
  ...
  INCLUDE_MAP_SUPPORT: 'Aktywuj obsługę mapy',
  MAP_CONFIG: 'Konfiguracja mapy',
  MAP_UNITS: 'Jednostki mapy',
  METRIC: 'Metryczny',
  IMPERIAL: 'Imperialny',
  OSM_AMENITIES: 'Udogodnienia OSM',
  TOGGLE_MAP: 'Pokaż/ukryj mapę',
  ZOOM_LEVEL: 'Poziom powiększenia',
  CIRCLE: 'Okrąg',
  ELLIPSE: 'Elipsa',
  OSM_QUERY: 'Zapytanie OSM',
  RADIUS: 'Promień (m)',
  RADII: 'Promienie (oddzielone przecinkami, w metrach)',
  MAJOR_AXIS: 'Półoś wielka (m)',
  MINOR_AXIS: 'Półoś mała (m)',
