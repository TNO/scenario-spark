...
export const messages: typeof messagesEN = {
  ...
  FILTER_NARRATIVES: 'Filtrer les scénarios',
  FILTER_NARRATIVES_PLACEHOLDER: 'Tapez pour filtrer par nom...',
  NARRATIVE: 'récit',
  ...
  INCLUDE_MAP_SUPPORT: 'Activer le support de carte',
  MAP_CONFIG: 'Configuration de la carte',
  MAP_UNITS: 'Unités de la carte',
  METRIC: 'Métrique',
  IMPERIAL: 'Impérial',
  OSM_AMENITIES: 'Équipements OSM',
  TOGGLE_MAP: 'Afficher/masquer la carte',
  ZOOM_LEVEL: 'Niveau de zoom',
  CIRCLE: 'Cercle',
  ELLIPSE: 'Ellipse',
  OSM_QUERY: 'Requête OSM',
  RADIUS: 'Rayon (m)',
  RADII: 'Rayons (séparés par des virgules, en mètres)',
  MAJOR_AXIS: 'Grand axe (m)',
  MINOR_AXIS: 'Petit axe (m)',
  ORIENTATION: 'Orientation',
  ORIENTATION_DESC: 'Angle en degrés (0 = Nord) ou ID de référence',
