export const messages = {
  ...
  FILTER_NARRATIVES: 'Filter scenarios',
  FILTER_NARRATIVES_PLACEHOLDER: 'Type to filter by name...',
  NARRATIVE: 'narrative',
  ...
  INCLUDE_MAP_SUPPORT: 'Activate map support',
  MAP_CONFIG: 'Map configuration',
  MAP_UNITS: 'Map units',
  METRIC: 'Metric',
  IMPERIAL: 'Imperial',
  OSM_AMENITIES: 'OSM Amenities',
  ...
  OSM_QUERY: 'OSM Query',
  RADIUS: 'Radius (m)',
  RADII: 'Radii (comma separated, in meters)',
  MAJOR_AXIS: 'Major axis (m)',
  MINOR_AXIS: 'Minor axis (m)',
  ORIENTATION: 'Orientation',
  ORIENTATION_DESC: 'Angle in degrees (0 = North) or reference ID',
  ...
  TOGGLE: { SHOW: 'Show map', HIDE: 'Hide map' },
  AUTO_CREATE: {
    BTN: 'Auto create',
