...
export const messages: typeof messagesEN = {
  ...
  FILTER_NARRATIVES: 'Szenarien filtern',
  FILTER_NARRATIVES_PLACEHOLDER: 'Zum Filtern nach Name eingeben...',
  NARRATIVE: 'Narrativ',
  ...
  INCLUDE_MAP_SUPPORT: 'Kartenunterstützung aktivieren',
  MAP_CONFIG: 'Kartenkonfiguration',
  MAP_UNITS: 'Karteneinheiten',
  METRIC: 'Metrisch',
  IMPERIAL: 'Imperial',
  OSM_AMENITIES: 'OSM-Einrichtungen',
  TOGGLE_MAP: 'Karte anzeigen/verbergen',
  ZOOM_LEVEL: 'Zoomstufe',
  CIRCLE: 'Kreis',
  ELLIPSE: 'Ellipse',
  OSM_QUERY: 'OSM-Abfrage',
  RADIUS: 'Radius (m)',
  RADII: 'Radien (kommagetrennt, in Metern)',
  MAJOR_AXIS: 'Große Halbachse (m)',
  MINOR_AXIS: 'Kleine Halbachse (m)',
